@extends('layouts.premium', ['pageTitle' => 'الموضة المستدامة', 'backRoute' => route('home')])
...
@section('content')
    ...
    <section class="pb-24 pt-2 md:pt-6 relative">
                    ...
                    <div class="relative w-full">
                        ...
                        <nav id="toc" class="flex lg:flex-col overflow-x-auto lg:overflow-visible no-scrollbar gap-1 snap-x font-semibold relative">
                            ...
                            <a href="#sec-3" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>المبادئ الأساسية للاستدامة </span>
                            </a>
                            <a href="#sec-4" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>الابعاد الرئيسية للتنمية المستدامة</span>
                            </a>
                            <a href="#sec-5" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>أهداف التنمية المستدامة الـ(SDG)</span>
                            </a>
                            <a href="#sec-6" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>الاعتبارات البيئية التي تجعل الياف النسيج مستدامة&quot; صديقة للبيئة</span>
                            </a>
                            <a href="#sec-7" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>دور الاستدامة في النسيج</span>
                            </a>
                            <a href="#sec-8" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>دور الاستدامة في الفن والتصميم</span>
                            </a>
                            <a href="#sec-9" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>أهم جوانب الاستدامة في التصميم والفن</span>
                            </a>
                            <a href="#sec-10" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>ثانيا / الاقمشة المستدامة &quot;الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-11" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>عوامل البيئة وعلاقتها في تصميم الاقمشة</span>
                            </a>
                            <a href="#sec-12" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>الالياف النسجية المستخدمة في تصنيع وإنتاج الاقمشة المستدامة</span>
                            </a>
                            <a href="#sec-13" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>مفهوم الاقمشة المستدامة&quot; الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-14" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>أنواع الأقمشة المستدامة &quot;الصديقة للبيئة&quot;</span>
                            </a>
                            <a href="#sec-15" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>الشروط الواجب توافرها في الأقمشة المستدامة &quot;الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-16" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>فوائد الاقمشة المستدامة &quot;الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-17" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>خصائص الاقمشة المستدامة &quot;الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-18" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>مميزات الاقمشة المستدامة &quot;الصديقة للبيئة&quot; </span>
                            </a>
                            <a href="#sec-19" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>خطوات عملية التصميم على الاقمشة (من الفكرة إلى الإنتاج)</span>
                            </a>
                            <a href="#sec-20" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>أنواع التصميم على الأقمشة</span>
                            </a>
                            <a href="#sec-21" class="toc-link flex items-center gap-2 snap-start shrink-0 lg:shrink px-3 lg:px-4 py-2 text-xs sm:text-sm lg:text-base border-r-2 border-transparent text-morris-text/70 hover:text-morris-terracotta hover:bg-morris-cream transition-colors rounded-l-lg pl-2 lg:pl-4 ">
                                <svg class="w-3.5 h-3.5 lg:w-4 lg:h-4 text-morris-olive/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg>
                                <span>أثر الاقمشة الصديقة للبيئة على العلامات التجارية</span>
                            </a>
                        </nav>
                    </div>
                </div>
        ...
        <section class="mb-14">
            <h2 id="sec-1" class="scroll-mt-40 lg:scroll-mt-32 text-2xl font-bold text-gray-800 mb-6 border-r-4 border-green-500 pr-3">اولا / الاستدامة:</h2>
            ...
            <h3 id="sec-2" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">مفهوم الاستدامة:</h3>
            ...
            <h3 id="sec-3" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">المبادئ الأساسية للاستدامة :</h3>
            ...
            <h3 id="sec-4" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">الابعاد الرئيسية للتنمية المستدامة:</h3>
            ...
            <figure class="my-8">
                <img src="{{ asset('images/fabric/img/fabrics-01.jpg') }}" class="w-full md:w-1/2 mx-auto w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 1">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                    شكل (2) الابعاد الرئيسية للتنمية المستدامة
                </figcaption>
            </figure>

            <h3 id="sec-5" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">أهداف التنمية المستدامة الـ(SDG)</h3>
            ...
            <figure class="my-8">
                <img src="{{ asset('images/fabric/img/fabrics-02.jpg') }}" class="w-full mx-auto w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 2">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            <h3 id="sec-6" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-4">الاعتبارات البيئية التي تجعل الياف النسيج مستدامة" صديقة للبيئة:</h3>
            ...
            <h3 id="sec-7" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">دور الاستدامة في النسيج</h3>
            ...
            <h3 id="sec-8" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">دور الاستدامة في الفن والتصميم</h3>
            ...
            <h3 id="sec-9" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">أهم جوانب الاستدامة في التصميم والفن:</h3>
        ...
        <section class="mb-14">
            <h2 id="sec-10" class="scroll-mt-40 lg:scroll-mt-32 text-2xl font-bold text-gray-800 mb-6 border-r-4 border-green-500 pr-3">ثانيا / الاقمشة المستدامة "الصديقة للبيئة" :</h2>
            <h3 class="text-xl font-bold text-gray-700 mb-3">مقدمة :</h3>
            <p>
            ...
            <div class="flex flex-col md:flex-row gap-8 items-start my-10">
                <div class="md:col-span-8 lg:col-span-9">
                    <h3 id="sec-11" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mb-2">عوامل البيئة وعلاقتها في تصميم الاقمشة</h3>
                ...
                <div class="md:col-span-4 lg:col-span-3">
                    <figure>
                        <img src="{{ asset('images/fabric/img/fabrics-03.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 3">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <h3 id="sec-12" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-4">الالياف النسجية المستخدمة في تصنيع وإنتاج الاقمشة المستدامة:</h3>
            <p>
            ...
            <figure class="my-10">
                <img src="{{ asset('images/fabric/img/fabrics-04.jpg') }}" class="w-full mx-auto w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 4">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            <h3 id="sec-13" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-8 mb-2">مفهوم الاقمشة المستدامة" الصديقة للبيئة" :</h3>
            ...
            <h3 id="sec-14" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">أنواع الأقمشة المستدامة "الصديقة للبيئة":</h3>
            ...
            <div class="mt-8 border-t border-gray-200 pt-8">
                ...
                <p class="text-gray-500 font-sans mb-4 text-right">Organic cotton fabric</p>
                ...
                <div class="flex flex-col md:flex-row gap-8 items-start mb-6">
                    ...
                    <div class="md:col-span-4 lg:col-span-3">
                        <figure>
                            <img src="{{ asset('images/fabric/img/fabrics-05.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 5">
                            <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                ...
                <div class="flex flex-col md:flex-row gap-6 my-6 justify-center">
                    <figure class="flex-1  mx-auto">
                        <img src="{{ asset('images/fabric/img/fabrics-06.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 6">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                    ...
                    <figure class="flex-1  mx-auto">
                        <img src="{{ asset('images/fabric/img/fabrics-07.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 7">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            ...
            <div class="flex flex-col md:flex-row gap-6 items-center my-8">
                <figure class="flex-1 min-w-[200px] md:min-w-[60%]">
                    <img src="{{ asset('images/fabric/img/fabrics-08.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 8">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                ...
                <figure class="w-full md:w-1/3">
                    <img src="{{ asset('images/fabric/img/fabrics-09.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 9">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                ...
                <p class="text-gray-500 font-sans mb-4 text-right">Bamboo fabric</p>
                ...
                <div class="flex flex-col md:flex-row gap-6 justify-center items-center my-8">
                    <figure class="w-full md:w-1/4">
                        <img src="{{ asset('images/fabric/img/fabrics-10.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 10">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                    ...
                    <figure class="flex-1 min-w-[200px] md:min-w-[60%]">
                        <img src="{{ asset('images/fabric/img/fabrics-11.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 11">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            ...
            <figure class="my-6  mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-12.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 12">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <figure class="my-6 max-w-md mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-13.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 13">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                ...
                <p class="text-gray-500 font-sans mb-4 text-right">recycled polyester fabric</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                    ...
                    <div class="md:col-span-4 lg:col-span-3 space-y-6">
                        <figure>
                            <img src="{{ asset('images/fabric/img/fabrics-14.jpg') }}" class="w-full mx-auto  w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 14">
                            <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                        ...
                        <figure>
                            <img src="{{ asset('images/fabric/img/fabrics-15.jpg') }}" class="w-full mx-auto  w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 15">
                            <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            ...
            <figure class="my-6  mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-16.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 16">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <figure class="my-6 max-w-md mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-17.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 17">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center items-center my-8">
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-18.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 18">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                ...
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-19.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 19">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                ...
                <p class="text-gray-500 font-sans mb-4 text-right">Organic linen fabric</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                    ...
                    <div class="md:col-span-4 lg:col-span-3">
                        <figure>
                            <img src="{{ asset('images/fabric/img/fabrics-20.jpg') }}" class="w-full mx-auto  w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 20">
                            <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            ...
            <figure class="my-6  mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-21.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 21">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <figure class="my-6 max-w-md mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-22.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 22">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center items-center my-8">
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-23.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 23">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                ...
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-24.jpg') }}" class="w-full mx-auto w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 24">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                ...
                <p class="text-gray-500 font-sans mb-4 text-right">Hemp fabric</p>
                ...
                <div class="flex flex-col md:flex-row gap-6 justify-center items-center my-8">
                    <figure class="w-full md:w-1/4">
                        <img src="{{ asset('images/fabric/img/fabrics-25.jpg') }}" class="w-full mx-auto  w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 25">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                    ...
                    <figure class="flex-1 min-w-[200px] md:min-w-[60%]">
                        <img src="{{ asset('images/fabric/img/fabrics-26.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 26">
                        <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14">
            ...
            <figure class="my-6 max-w-sm mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-27.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 27">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <figure class="my-6 max-w-md mx-auto">
                <img src="{{ asset('images/fabric/img/fabrics-28.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 28">
                <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center items-center my-8">
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-29.jpg') }}" class="w-full w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 29">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
                ...
                <figure class="flex-1 max-w-sm">
                    <img src="{{ asset('images/fabric/img/fabrics-30.jpg') }}" class="w-full mx-auto w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 30">
                    <figcaption class="text-center mt-3 text-sm font-sans text-gray-600">
        ...
        <section class="mb-14 border-t border-gray-200 pt-8">
            <h3 id="sec-15" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mb-2">الشروط الواجب توافرها في الأقمشة المستدامة "الصديقة للبيئة" :</h3>
            ...
            <h3 id="sec-16" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">فوائد الاقمشة المستدامة "الصديقة للبيئة" :</h3>
            ...
            <h3 id="sec-17" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">خصائص الاقمشة المستدامة "الصديقة للبيئة" :</h3>
            ...
            <h3 id="sec-18" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-2">مميزات الاقمشة المستدامة "الصديقة للبيئة" :</h3>
        ...
        <section class="mb-14 border-t border-gray-200 pt-8">
            <h3 id="sec-19" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mb-4">خطوات عملية التصميم على الاقمشة (من الفكرة إلى الإنتاج):</h3>
            <ol class="list-decimal text-gray-800">
            ...
            <h3 id="sec-20" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mt-10 mb-4">أنواع التصميم على الأقمشة:</h3>
        ...
        <section class="mb-8 border-t border-gray-200 pt-8">
            <h3 id="sec-21" class="scroll-mt-40 lg:scroll-mt-32 text-xl font-bold text-gray-700 mb-2">أثر الاقمشة الصديقة للبيئة على العلامات التجارية</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('images/fabric/img/fabrics-31.jpg') }}" class="w-full mb-2 w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 31">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('images/fabric/img/fabrics-32.jpg') }}" class="w-full mb-2 w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 32">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('images/fabric/img/fabrics-33.jpg') }}" class="w-full mb-2 w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 33">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="{{ asset('images/fabric/img/fabrics-34.jpg') }}" class="w-full mb-2 w-full h-auto object-cover rounded-2xl shadow-md" alt="Fabric image 34">
